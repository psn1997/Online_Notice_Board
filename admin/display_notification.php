...
if (!$rr) {
    echo "<h2 style='color:red'>Hooray, no notice here!</h2>";
} else {
    ?>
    <h2 style="color:#0D47A1">All Notice</h2>
    ...
    <table class="table table-bordered">
        ...
        while ($row = mysqli_fetch_assoc($q)) {
            ...
            <Td><a href="javascript:DeleteNotice('<?php echo $row['notice_id']; ?>')" style='color:Red'><span
