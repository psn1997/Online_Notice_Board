...
//$query="insert into user values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$dob',now())";
    ...
    $err = "<font color='blue'>Success! Profile updated</font>";
}
//select old data
...
<form method="post">
    <table class="table table-bordered">
        ...
        <tr>
            <td>Email</td>
            <Td><input class="form-control" type="email" readonly="true" value="<?php echo $res['email']; ?>" name="e"/>
            </td>
        </tr>
        <tr>
            <td>Mobile</td>
        ...
        <tr>
            <td>Gender</td>
            <Td>
                Male&nbsp;<input type="radio" <?php if ($res['gender'] == "m") {
                    echo "checked";
                } ?> name="gen" value="m"/>
                Female&nbsp;<input type="radio" <?php if ($res['gender'] == "f") {
                    echo "checked";
                } ?> name="gen" value="f"/>
            </td>
        </tr>
        <tr>
            ...
            <Td>
                ...
                ?>
                Reading&nbsp;<input value="reading" <?php if (in_array("reading", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Singing&nbsp;<input value="singin" <?php if (in_array("singin", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Playing&nbsp;<input value="playing" <?php if (in_array("playing", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Swimming&nbsp;<input value="reading" <?php if (in_array("swimming", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Dancing&nbsp;<input value="singin" <?php if (in_array("dancing", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Travelling&nbsp;<input value="playing" <?php if (in_array("Travelling", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
                Cooking&nbsp;<input value="playing" <?php if (in_array("cooking", $arrr)) {
                    echo "checked";
                } ?> type="checkbox" name="hob[]"/>
            </td>
        </tr>
