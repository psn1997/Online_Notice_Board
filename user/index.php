...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background:#42A5F5">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" style="color: black">Hello <?php echo $users['name']; ?></a>
        </div>
            ...
            <ul class="nav nav-sidebar">
                ...
                if ($row['image'] == "") {
                    ...
                    <li><a href="index.php?page=update_profile_pic"><img title="Update Your profile pic Click here"
                                                                         ...
                                                                         src="../images/person.jpg" width="100"
                    ...
                    <li><a href="index.php?page=update_profile_pic"><img title="Update Your profile pic Click here"
                                                                         style="border-radius:50px"
                                                                         src="../images/<?php echo $_SESSION['user']; ?>/<?php echo $row['image']; ?>"
                                                                         width="100" height="100" alt="not found"/></a>
                    </li>
                    <?php
                }
                ?>
